  ...
  <div class="product-details"><!--product-details-->
    <div class="col-sm-5">
      <div class="flexslider">
        <ul class="slides">
          <li data-thumb="{!!asset($info->image[0]->path)!!}">
            <img src="{!!asset($info->image[0]->path)!!}" />
          </li>
          <li data-thumb="{!!asset($info->image[1]->path)!!}">
            <img src="{!!asset($info->image[1]->path)!!}" />
          </li>
          <li data-thumb="{!!asset($info->image[2]->path)!!}">
            <img src="{!!asset($info->image[2]->path)!!}" />
          </li>
          <li data-thumb="{!!asset($info->image[3]->path)!!}">
            <img src="{!!asset($info->image[3]->path)!!}" />
          </li>
        </ul>
      </div>
    </div>
    <div class="col-sm-7">
      ...
      <p><b>Availability:</b> {{$info->status}}</p>
      <p><b>Condition:</b> {{$info->condition}}</p>
      <p><b>Brand:</b> {{$info->branch->name}}</p>
      <span>
        <div class="col-md-4">
          <span><div class="fb-like" data-href="" data-layout="button" data-action="like" data-size="small" data-show-faces="false" data-share="false"></div></span>
        </div>
        <div class="col-md-4">
